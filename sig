...
local Themes = {
	...
	Secret = {
		...
		AcrylicGradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 36, 81)),
        ...
        TitleBarLine = Color3.fromRGB(64, 79, 125), -- editorGroup.border
        Tab = Color3.fromRGB(255, 255, 255), -- editor.foreground
    
        Element = Color3.fromRGB(0, 23, 51), -- input.background
        ElementBorder = Color3.fromRGB(64, 79, 125), -- editorGroup.border
        InElementBorder = Color3.fromRGB(187, 218, 255), -- focusBorder
        ElementTransparency = 0,
    
        ToggleSlider = Color3.fromRGB(187, 218, 255), -- focusBorder
        ToggleToggled = Color3.fromRGB(0, 23, 51), -- input.background
    
        SliderRail = Color3.fromRGB(187, 218, 255), -- focusBorder
    
        DropdownFrame = Color3.fromRGB(0, 23, 51), -- dropdown.background
        DropdownHolder = Color3.fromRGB(0, 23, 51), -- dropdown.background
        DropdownBorder = Color3.fromRGB(64, 79, 125), -- editorGroup.border
        DropdownOption = Color3.fromRGB(255, 255, 255), -- editor.foreground
    
        Keybind = Color3.fromRGB(0, 23, 51), -- input.background
    
        Input = Color3.fromRGB(0, 23, 51), -- input.background
        InputFocused = Color3.fromRGB(0, 23, 51), -- input.background
        InputIndicator = Color3.fromRGB(64, 79, 125), -- editorWhitespace.foreground
    
        Dialog = Color3.fromRGB(0, 28, 64), -- editorWidget.background
        DialogHolder = Color3.fromRGB(0, 28, 64), -- editorWidget.background
        DialogHolderLine = Color3.fromRGB(64, 79, 125), -- editorGroup.border
        DialogButton = Color3.fromRGB(0, 23, 51), -- input.background
        DialogButtonBorder = Color3.fromRGB(64, 79, 125), -- editorGroup.border
        DialogBorder = Color3.fromRGB(255, 255, 255), -- editorHoverWidget.border
        DialogInput = Color3.fromRGB(0, 23, 51), -- input.background
        DialogInputLine = Color3.fromRGB(187, 218, 255), -- focusBorder
    
        Text = Color3.fromRGB(255, 255, 255), -- editor.foreground
        SubText = Color3.fromRGB(114, 133, 183), -- Comment color from tokenColors
        Hover = Color3.fromRGB(255, 255, 255), -- list.hoverBackground
        HoverChange = 0.1
	}
}
